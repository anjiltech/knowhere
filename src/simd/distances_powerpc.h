...
void
fvec_L2sqr_ny_ref_ppc(float* dis, const float* x, const float* y, size_t d, size_t ny);

/// compute the inner product between nx vectors x and one y
void
fvec_inner_products_ny_ref_ppc(float* ip, const float* x, const float* y, size_t d, size_t ny);
...
void
fvec_L2sqr_ny_transposed_ref_ppc(float* dis, const float* x, const float* y, const float* y_sqlen, size_t d,
...
/// return 0 if ny == 0.
size_t
fvec_L2sqr_ny_nearest_ref_ppc(float* distances_tmp_buffer, const float* x, const float* y, size_t d, size_t ny);
...
/// return 0 if ny == 0.
size_t
fvec_L2sqr_ny_nearest_y_transposed_ref_ppc(float* distances_tmp_buffer, const float* x, const float* y,
                                           const float* y_sqlen, size_t d, size_t d_offset, size_t ny);

void
fvec_madd_ref_ppc(size_t n, const float* a, float bf, const float* b, float* c);

int
fvec_madd_and_argmin_ref_ppc(size_t n, const float* a, float bf, const float* b, float* c);

/// Special version of inner product that computes 4 distances
/// between x and yi, which is performance oriented.
void
fvec_inner_product_batch_4_ref_ppc(const float* x, const float* y0, const float* y1, const float* y2, const float* y3,
                                   const size_t d, float& dis0, float& dis1, float& dis2, float& dis3);

/// Special version of L2sqr that computes 4 distances
/// between x and yi, which is performance oriented.
void
fvec_L2sqr_batch_4_ref_ppc(const float* x, const float* y0, const float* y1, const float* y2, const float* y3,
                           const size_t d, float& dis0, float& dis1, float& dis2, float& dis3);
