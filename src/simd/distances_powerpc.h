...
void
fvec_L2sqr_ny_transposed_ppc(float* dis, const float* x, const float* y,
...
/// return 0 if ny == 0.
size_t
fvec_L2sqr_ny_nearest_ppc(float* distances_tmp_buffer, const float* x,
...
/// return 0 if ny == 0.
size_t
fvec_L2sqr_ny_nearest_y_transposed_ppc(float* distances_tmp_buffer,
...
void
fvec_inner_product_batch_4_ppc(const float* x, const float* y0,
